...
std::string Entity::getDna() const
{
	return (this->_dna);
}
...
int Entity::getPotential() const
{
	return (this->_potential);
}

void Entity::setDna(std::string NewDna)
{
	this->_dna = NewDna;
}
...
Entity::Entity(Entity const &ObjB): _dna(ObjB._dna), _dnaLength(ObjB._dnaLength), _potential(0)
{
